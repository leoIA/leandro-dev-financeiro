...
/** @var string $mensagem */
$mensagem = $mensagem ?? 'Tente novamente em instantes. Se o erro persistir, contate o administrador do sistema.';
?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
    ...
    <title>500 — Erro interno do servidor — Leandro DEV Financeiro</title>
    ...
    <div class="container">
        <div class="card shadow error-card border-0">
            <div class="card-body text-center py-5">
                ...
                <h1 class="display-5 fw-bold mt-3 mb-2">500</h1>
                <h2 class="h5 text-muted mb-3">Erro interno do servidor</h2>
